...
export function getKeyByVal (val: number|string, obj: AnyObj): string {
 ...
 */
export function getValByVal (val: string|number, list: Array<any>, field: AnyObj) {
 ...
 */
export function pick (obj: AnyObj, props: string[]) {
 ...
 */
export function objectToObjArray (obj: AnyObj, keyConvert: string, valueConvert: string) {
  if (
    getType(obj) !== 'Object' ||
 ...
 */
export function mixParams (params: AnyObj, paramsMap: AnyObj) {
  const keys = Object.keys(params)
  if (!keys.length) return params
  return keys.reduce((pre: AnyObj, item: string) => {
 ...
 */
export function listToHash (list: Array<any>, key: string) {
  return list.reduce((pre: AnyObj, item: AnyObj) => {
